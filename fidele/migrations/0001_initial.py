# Generated by Django 5.1.3 on 2025-11-19 21:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['type'], name='fidele_noti_type_1d4d39_idx'), models.Index(fields=['-created_at'], name='fidele_noti_created_87fbcf_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.CharField(choices=[('LOW', 'Faible'), ('MED', 'Moyenne'), ('HIGH', 'Élevée'), ('CRIT', 'Critique')], default='MED', max_length=5)),
                ('status', models.CharField(choices=[('OPEN', 'Ouvert'), ('WIP', 'En cours'), ('HOLD', 'En attente'), ('DONE', 'Résolu'), ('CANC', 'Annulé')], default='OPEN', max_length=5)),
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('assignee', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='fidele.fidele')),
                ('eglise', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='fidele.eglise')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('reporter', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='fidele.fidele')),
                ('category', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='fidele.problemcategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolution_notes', models.TextField(blank=True, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('assignee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_problems', to='fidele.fidele')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='fidele.problemcategory')),
                ('eglise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_reports', to='fidele.eglise')),
                ('reporter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_reports', to='fidele.fidele')),
                ('watchers', models.ManyToManyField(blank=True, related_name='watched_problems', to='fidele.fidele')),
            ],
            options={
                'ordering': ['-created_at'],
                'permissions': (('can_assign_problem', 'Peut assigner un problème à un responsable'), ('can_view_all_problems', "Peut voir tous les problèmes de l'église")),
            },
        ),
        migrations.CreateModel(
            name='ProblemAction',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('COMMENT', 'Commentaire'), ('ASSIGN', 'Assignation'), ('STATUS', 'Changement de statut')], max_length=16)),
                ('message', models.TextField(blank=True)),
                ('meta', models.JSONField(blank=True, default=dict)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='fidele.fidele')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actions', to='fidele.problemreport')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            model_name='fidele',
            name='roles',
            field=models.ManyToManyField(blank=True, related_name='fideles', to='fidele.role'),
        ),
        migrations.CreateModel(
            name='Sacrement',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_entries', to='fidele.notification')),
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'is_read'], name='fidele_noti_user_id_64c664_idx'), models.Index(fields=['user', 'created_at'], name='fidele_noti_user_id_dd6b1e_idx')],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['eglise', 'status'], name='fidele_prob_eglise__4413c0_idx'),
        ),
        migrations.AddIndex(
            model_name='problemreport',
            index=models.Index(fields=['assignee', 'status'], name='fidele_prob_assigne_dd47eb_idx'),
        ),
        migrations.AddIndex(
            model_name='problemreport',
            index=models.Index(fields=['severity'], name='fidele_prob_severit_535042_idx'),
        ),
        migrations.AddIndex(
            model_name='problemreport',
            index=models.Index(fields=['created_at'], name='fidele_prob_created_6aebdf_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='verseofday',
            index=models.Index(fields=['date', 'notified_at'], name='fidele_vers_date_b6d714_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='verseusage',
            index=models.Index(fields=['eglise', 'used_on'], name='fidele_vers_eglise__4cb6ff_idx'),
        ),
        migrations.AddIndex(
            model_name='verseusage',
            index=models.Index(fields=['eglise', 'book', 'chapter', 'verse'], name='fidele_vers_eglise__2fd349_idx'),
        ),
    ]
